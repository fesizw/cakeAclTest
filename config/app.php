...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'fcfad8c75aa75ff7874aaaa43b3131285cf9b222733ccd35d553b9033d05cf12'),
    ],
    /**
    ...
    'Datasources' => [
        ...
        /**
         * The test connection is used during the Developper and primary test.
         */
        'developper' => [
            'className' => 'Cake\Database\Connection',
            'driver' => 'Cake\Database\Driver\Mysql',
            ...
            //'port' => 'non_standard_port_number',
            'username' => 'slink_jur',
            'password' => '11lRvb__aZqXo00',
            'database' => 'slink_intra',
            /*
             * You do not need to set this flag to use full utf-8 encoding (internal default since CakePHP 3.6).
             */
            //'encoding' => 'utf8mb4',
        ...
        /**
         * The test connection is used during the Homologation test.
         */
        'homologation' => [
            'className' => 'Cake\Database\Connection',
