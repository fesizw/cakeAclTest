...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Estado Civil'), ['action' => 'edit', $estadoCivil->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Estado Civil'), ['action' => 'delete', $estadoCivil->id], ['confirm' => __('Are you sure you want to delete # {0}?', $estadoCivil->id)]) ?> </li>
...
<div class="estadoCivils view large-9 medium-8 columns content">
    <h3><?= h($estadoCivil->id) ?></h3>
    <table class="vertical-table">
        <tr>
            <th scope="row"><?= __('Tipo Estado Civil') ?></th>
    ...
    <div class="related">
        ...
        <?php if (!empty($estadoCivil->clientes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoCivil->clientes as $clientes): ?>
            <tr>
                <td><?= h($clientes->id) ?></td>
