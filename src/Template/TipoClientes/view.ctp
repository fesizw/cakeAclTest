...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Tipo Cliente'), ['action' => 'edit', $tipoCliente->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Tipo Cliente'), ['action' => 'delete', $tipoCliente->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tipoCliente->id)]) ?> </li>
...
<div class="tipoClientes view large-9 medium-8 columns content">
    <h3><?= h($tipoCliente->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($tipoCliente->clientes)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($tipoCliente->clientes as $clientes): ?>
            <tr>
                <td><?= h($clientes->id) ?></td>
