...
//        ]);
    ...
    // 	return $this->redirect('https://' . $_SERVER['HTTP_HOST'] . $this->request->getRequestTarget());
    // }

    public function beforeSave() {
        parent::beforeSave();
        $this->request->data['User']['senha'] = AuthComponent::password($this->request->data['User']['senha']);
    }
