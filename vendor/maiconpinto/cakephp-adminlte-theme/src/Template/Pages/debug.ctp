...
<section class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="callout <?= $class ?>">
                ...
                <?php if (version_compare(PHP_VERSION, '5.6.0', '>=')): ?>
                    <p class="success">Your version of PHP is 5.6.0 or higher (detected <?= phpversion() ?>).</p>
                <?php else: ?>
                    <p class="problem">Your version of PHP is too low. You need PHP 5.6.0 or higher to use CakePHP (detected <?= phpversion() ?>).</p>
                <?php endif; ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
//            $settings = Cache::config('_cake_core_'); Depreciado
