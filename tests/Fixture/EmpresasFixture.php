...
class EmpresasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cnpj' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-01-08 19:37:23',
                'modified' => '2019-01-08 19:37:23'
            ],
        ];
        parent::init();
    }
