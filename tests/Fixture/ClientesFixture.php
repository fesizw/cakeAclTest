...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nome_cliente' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'NomeCliente', 'precision' => null, 'fixed' => null],
        ...
        'data_nascimento' => ['type' => 'datetime', 'length' => null, 'null' => true, 'default' => null, 'comment' => 'DataNascimento', 'precision' => null],
        ...
        'usuario_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'Quem Lançou', 'precision' => null, 'autoIncrement' => null],
        'profissão_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'CodProf', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_nascimento' => '2019-01-08 19:37:07',
                ...
                'created' => '2019-01-08 19:37:07',
                'modified' => '2019-01-08 19:37:07',
                'tipo_cliente_id' => 1,
