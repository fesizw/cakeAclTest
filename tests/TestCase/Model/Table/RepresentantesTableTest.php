...
class RepresentantesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Representantes') ? [] : ['className' => RepresentantesTable::class];
        $this->Representantes = TableRegistry::getTableLocator()->get('Representantes', $config);
    }
